...
/*
 * Note: This file should be kept in sync as much as possible between:
 *
 * - smartos-live/src/node_modules/zfs.js
 * - node-zfs/lib/zfs.js
 *
 * If you update one, please be sure to update the other and perform all
 * necessary regression tests. Preferably, make changes to node-zfs then
 * copy the whole file into smartos-live.
 */
